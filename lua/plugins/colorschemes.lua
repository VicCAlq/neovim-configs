return {
  ...
  { "2nthony/vitesse.nvim",             name = "vitesse",       lazy = false, priority = 1000, dependencies = { "tjdevries/colorbuddy.nvim" }, },
  ...
  { "clpi/cyu.lua",                     name = "cyu",           lazy = false, priority = 1000, },
  ...
  { "atelierbram/Base4Tone-nvim",       name = "base4tone",     lazy = false, priority = 1000, },
  ...
  { "AntonyZ89/electron-vue.nvim",      name = "electron-vue",  lazy = false, priority = 1000, dependencies = { "rktjmp/lush.nvim" }, },
